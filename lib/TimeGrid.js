...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    var _endOfRange = (0, _eventLevels.endOfRange)(range);
    ...
    var segments = allDayEvents.map(function (evt) {
      return (0, _eventLevels.eventSegments)(evt, first, last, _this2.props);
    });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        this.props.renderTimeLabel && _react2.default.createElement(_TimeColumn2.default, _extends({}, this.props, {
          showLabels: true,
          style: { width: width },
          ref: gutterRef,
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range, events, today) {
    ...
    return range.map(function (date, idx) {
      ...
      return _react2.default.createElement(_DayColumn2.default, _extends({}, _this3.props, {
        ...
        style: (0, _eventLevels.segStyle)(1, _this3._slots),
        key: idx,
        date: date,
        events: daysEvents
      }));
  ...
  TimeGrid.prototype.renderAllDayEvents = function renderAllDayEvents(range, levels) {
    ...
    var _endOfRange2 = (0, _eventLevels.endOfRange)(range);
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(range, segments, width) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'rbc-row' },
        this.props.renderTimeLabel && _react2.default.createElement('div', {
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    var dayFormat = _props4.dayFormat;
    var culture = _props4.culture;
    var components = _props4.components;
    ...
    return range.map(function (date, i) {
      return _react2.default.createElement(
        'div',
        {
          ...
          style: (0, _eventLevels.segStyle)(1, _this5._slots)
        },
        _react2.default.createElement(
          'a',
          { href: '#', onClick: _this5._headerClick.bind(null, date) },
  ...
  TimeGrid.prototype.calculateScroll = function calculateScroll() {
    ...
    var min = _props5.min;
    var max = _props5.max;
    var scrollToTime = _props5.scrollToTime;
...
TimeGrid.propTypes = _extends({}, _DayColumn2.default.propTypes, _TimeColumn2.default.propTypes, {
  ...
  renderHeader: _react2.default.PropTypes.bool,
  renderTimeLabel: _react2.default.PropTypes.bool
});
